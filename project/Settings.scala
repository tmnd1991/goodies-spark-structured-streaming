...
object Settings {
  ...
  val name: String = "goodies-spark-structured-streaming"
  val organization: String = "com.github.tmnd1991"
  val scala_211 = "2.11.12"
  val scala = "2.12.12"
  val crossScalaVersions = Seq(scala_211, scala)
  val SCALA_211: Option[(Long, Long)] = Some((2L, 11L))
  val SCALA_212: Option[(Long, Long)] = Some((2L, 12L))
  ...
  def scalacOptionsVersion(scalaVersion: String): Seq[String] =
    Seq(
      ...
      case SCALA_211 => Seq("-Xlint", "-Ywarn-unused-import")
      case SCALA_212 =>
        Seq(
      ...
      case _ => throw new Exception(s"Unknown scala version: $scalaVersion")
    })

  def scalaDocOptionsVersion(scalaVersion: String): Seq[String] =
    CrossVersion.partialVersion(scalaVersion) match {
      case SCALA_211                     => scalacOptionsVersion(scalaVersion)
